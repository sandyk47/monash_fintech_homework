...
// employee address for quick reference: 0x421bDD138D2a17F93c97675526323d605770D0E4
...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        // Your code here!
        require(unlock_time <= now, "Your shares haven't vested yet, fool.");
        require(distributed_shares <= total_shares, "There are no shares left to vest, fool");
